...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', type=str, default='bartlarge')
    parser.add_argument('--test_ckp', type=str,
                        default='/home/qinpeixin/InteractiveEvaluation/CQG/src/tb_logs/bartlarge/version_1/checkpoints/epoch=4-step=70.ckpt')
    ...
    parser.add_argument("--trainer_batch_size", type=int, default=32,
